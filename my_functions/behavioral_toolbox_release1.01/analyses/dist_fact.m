...
%  DIST_FACT  Computes a distance-based clustering factor.
%
...
dist_facts = apply_by_index(@dist_fact_for_subj, ...
			    subjects, ...
			    1, ...
			    {recalls_itemnos, pres_itemnos, rec_mask, pres_mask}, ...
			    dist_mat);
%endfunction
...
for i = 1:num_trials
    ...
    [act_dists, pos_dists] = conditional_transitions(...
                             recalls_itemnos(i, :), rec_mask(i, :), ...
                             rec_mask(i, :), ...
                             @similarity, ...
                             @possible_sim_transitions, ...
                             step, params);
